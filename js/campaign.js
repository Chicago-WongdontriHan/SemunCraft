...
function startCampaignLevel(levelIdx){
  ...
  gameMode='campaign';
  difficulty='campaign';
  campaignLost=0;campaignKingHit=false;campaignDefeat='';scans=[];meteors=[];flareTiles=[];elixir={w:0,b:0};mineTurns={w:0,b:0};goldSpent={w:0,b:0};orderLeft={w:ORDER_BUDGET,b:ORDER_BUDGET};
