...
const TUTORIAL_STEPS=[
  ...
  // ── ROOK ──────────────────────────────────────────────────────────────────
  {
    ...
    onAttack(){
      ...
      tutWaitForNext(()=>{
        ...
        // but within the siege tower's range (2 to 4 squares in a straight line) once merged at (4,3)
        ...
        document.getElementById('tut-desc').textContent='Excellent! A distant enemy queen looms at the top edge — too far for rooks to reach. Merge the two rooks into a Siege Tower to fire 2 to 4 squares in a straight line. Drag the highlighted rook onto the other rook.';
  ...
  {
    title:'Siege Tower 🏰',
    desc:'The Siege Tower cannot move, but fires 2 to 4 squares in a straight line (never the square beside it) — now within range of the enemy queen. Wait for the siege tower to fire at the queen, then right-click (or tap twice) the siege tower to unsiege it back into two rooks.',
